...
// displayLeaderboard(generation);
const urlParams = new URLSearchParams(window.location.search);
const username = urlParams.get('username');
console.log("Username is: " +generation);

document.getElementById('logoutBtn').addEventListener('click', function() {
//   window.location.href = "leader_update.php?generation=" + generation + "&username=" + username;
  window.location.href = "logout.php?generation=" +generation+ "&username=" + username;
});

// add an event listener to the 'reset' button
document.getElementById('reset_button').addEventListener('click', function() {

 window.location.href = "main.php?generation=" +generation+ "&username=" + username;
 reset();
//   window.location.href = 'main.php';
});